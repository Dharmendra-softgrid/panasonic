              ...
              <h5 class="card-title">Slider</h5>
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">
                   ...
                   @endif
                   <input type="text" name="title" class="form-control" value="{{isset($slider->slide_title) ? $slider->slide_title : ''  }}">
                   @if($errors->has('title'))
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">                   
                   <input type="text" name="type" class="form-control" value="{{isset($slider->type) ? $slider->type : ''  }}">
                   @if($errors->has('type'))
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="card ">
                        ...
                        <img src="{{asset(isset($slider->image) ? 'images/'.$slider->image : 'images/computerbanner.jpg')}}" class="banner-img" alt="..." id="bannerimagepreview">
                        <div class="card-body text-center ">
