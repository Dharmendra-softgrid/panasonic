              ...
              <h5 class="card-title">Story</h5>
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">
                   ...
                   @endif
                   <input type="text" name="title" class="form-control" value="{{isset($successstory->title) ? $successstory->title : ''  }}">
                   @if($errors->has('title'))
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">                   
                   <input type="text" name="short_description" class="form-control" value="{{isset($successstory->short_description) ? $successstory->short_description : ''  }}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">                   
                   <input type="text" name="year" class="form-control" value="{{isset($successstory->year) ? $successstory->year : ''  }}">
                   @if($errors->has('year'))
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">                   
                   <input type="text" name="company" class="form-control" value="{{isset($successstory->company) ? $successstory->company : ''  }}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-10">                   
                   <input type="text" name="type" class="form-control" value="{{isset($successstory->type) ? $successstory->type : ''  }}">
                   @if($errors->has('type'))
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="card ">
                        ...
                        <img src="{{asset(isset($successstory->banner_image) ? 'images/'.$successstory->banner_image : 'images/computerbanner.jpg')}}" class="banner-img" alt="..." id="bannerimagepreview">
                        <div class="card-body text-center ">
